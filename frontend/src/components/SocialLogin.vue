<template>
  <div class="signup-buttons">
    <div id="fb-root"></div>
    <a href="#" class="google-signup" @click.prevent="redirectToGoogle">
    ...
    <a href="#" class="facebook-signup" @click.prevent="redirectToFacebook">
...
export default {
  ...
  methods: {
    redirectToGoogle() {
      const url = `http://localhost:8080/oauth2/authorization/google?redirect_uri=${this.$oauth2Redirect}`;
