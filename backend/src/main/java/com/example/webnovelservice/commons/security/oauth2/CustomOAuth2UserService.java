...
import com.example.webnovelservice.commons.security.oauth2.user.OAuth2UserInfoFactory;
...
import com.example.webnovelservice.commons.security.oauth2.user.OAuth2UserInfo;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        // OAuth2User contains user information after a successful authentication
        OAuth2UserInfo oAuth2UserInfo = OAuth2UserInfoFactory.getOAuth2UserInfo(oAuth2UserRequest.getClientRegistration().getRegistrationId(), oAuth2User.getAttributes());
        if(!StringUtils.hasLength(oAuth2UserInfo.getEmail())) {
            throw new OAuth2AuthenticationProcessingException("Email not found from OAuth2 provider");
        }

        // update or register user information on our database.
        ...
        // OAuth2User 를 구현한 UserPrincipal 객체를 반환
